...
class ValidationTest(unittest.TestCase):
    ...
    def test_main_runs_all_validation_steps_on_success(self) -> None:
        with patch("ai_code_agent.validation._run_step", side_effect=[0, 0, 0, 0, 0]) as mock_run_step:
    ...
    def test_main_stops_after_first_failing_step(self) -> None:
        with patch("ai_code_agent.validation._run_step", side_effect=[0, 7, 0, 0, 0]) as mock_run_step:
            exit_code = validation.main()
